...
과거 냉전 시대의 공산주의와 자유주의처럼 양립할 수 없는 두 가지 이념이 소프트웨어 개발 분야에 존재한다. 바로 원리주의와 실용주의다. 소프트웨어 개발은 매우 복잡한 과정이며, 이 두 가지 이념은 각기 다른 방식으로 문제에 접근한다. 따라서 원리주의와 실용주의는 소프트웨어 개발의 성패를 좌우하는 중요한 요소라 할 수 있다.

원리주의자들은 체계적인 소프트웨어 개발 이론을 바탕으로 개발을 진행해야 한다고 믿는다. 이들은 유지보수의 중요성을 강조하며, 장기적인 관점에서 신중하게 코드를 작성할 것을 주장한다. 반면 실용주의자들은 문제를 최대한 간단하고 빠르게 해결하는 데 초점을 맞춘다. 소프트웨어는 복잡하기 때문에 아무리 신중하게 코드를 작성해도 효과가 없다고 생각한다. 그래서 초기에 많은 시간을 투자하기보다는 문제가 발생할 때마다 즉각 대응하는 것이 효율적이라고 생각한다.

그런데 개발자를 원리주의자나 실용주의자로 명확히 구분 짓기는 어렵다. 대부분의 개발자들은 이 두 이념의 스펙트럼 상에서 중간 어딘가에 위치할 것이다. 또한 상황에 따라 개발자의 성향이 변화할 수 있기에 이러한 구분은 더욱 모호해질 수밖에 없다.

이 글에서는 극단적인 원리주의 개발자와 실용주의 개발자에 주목하고자 한다. 이들의 상반된 관점과 접근 방식, 그리고 협업 과정에서 발생하는 문제들을 살펴본다.
...
그것이 아니라면 API 설계 등 협업이 필요한 부분에서 원리주의 팀장과 실용주의 팀장은 사사건건 의견이 충돌할 것이다.

### 6.1 마이크로 관리자의 중재

두 팀장이 충돌하면 팀 간 조율의 책임이 있는 마이크로 관리자는 자신이 논리적으로 판단하고 결정을 내리기 위해서 양측의 의견을 듣게 된다.

마이크로 관리자는 공정하고 객관적으로 판단하려고 하겠지만 이런 상황은 이미 원리주의 팀장이 불리한 입장에서 시작하게 된다.

원리주의 팀장은 자신의 논리를 소프트웨어 개발 이론과 섞어가면서 장황하게 설명해야 한다. 반면에 실용주의 팀장은 원리주의 팀장의 주장에 '왜요?'라고 묻기만 하면 된다. 원리주의 팀장이 어지간한 지식이 었어도 실용주의 팀장의 '왜요?' 공격을 방어하기는 쉽지 않다. 어느 순간 설명하기 어려운 지점에 이를 것이다. 더군다나 개발 지식이 부족한 마이크로 관리자까지 이해를 시켜야 하기 때문에 원리주의 팀장은 2:1로 논쟁하는 입장이 된다.
...
혹은 마이크로 관리자가 둘이 잘 협의하라는 지시와 함께 중재를 포기하는 경우도 있는데 이것은 최악의 선택이다. 마지막 브레이크마저 사라진 두 팀장의 갈등은 극한으로 치닫고 좀 더 쉽게 지치게 되는 원리주의 팀장이 퇴사를 하는 것으로 끝이 날 것이다.

### 6.2 원리주의 팀장의 입장

원리주의 팀장은 실용주의 팀장이 자신의 발목을 잡는다고 생각한다. 원리주의 팀장의 눈에 실용주의 팀장은 자신의 편의만을 추구하며, 회사와 프로젝트에 암세포와 같은 존재로 비춰진다.
실용주의 팀장의 개발 역량을 낮게 보고 개발을 잘 모른다고 생각한다.

오래된 프로젝트라면 구조적 문제가 있어서 이것을 해결해야 하는데 실용주의 팀장은 반대만 한다.

### 6.3 실용주의 팀장의 입장

실용주의 팀장 역시 원리주의 팀장을 곱지 않은 시선으로 바라본다. 실용주의 팀장은 원리주의 팀장이 자신도 완벽하게 다루지 못하는 기술을 무리하게 도입함으로써 프로젝트의 진행을 방해한다고 여긴다. 아울러 원리주의 팀장이 개인의 성장에만 집착한 나머지 정작 프로젝트의 성공은 뒷전으로 미룬다고 생각한다.
...
정말 다양한 인간이 있다. 개발에 대한 순수한 열정이 있고 그럴듯하게 자신을 포장하는 개발자도 있다. 순수한 실용주의도 있다. 두 극단주의의 대립을 썼지만 순수하기만 하면 의외로 잘 지낼 수 있다. 원리주의냐 순수주의처럼 보이지만 그럴듯하게 자신을 포장하면서 자신의 이익에 따라 판단하는 부류가 갈등의 가장 큰 원인이다. 그러니까 자신의 이익에 따라 원리주의냐 실용주의냐를 주장하는 것인데 이직에 관심이 있거나 일이 하기 싫을 때다. 상대방의 이런 의도를 눈치채면 협조하기 싫은 것이다. 개인의 성향에 따른 판단은 존중할 수 있지만 이기심에 의한 판단을 존중하기는 어려운 것이다. 기술적 판단은 언제든 개선이 가능하지만 개인의 이기심에 의한 판단은 점점 악화될 것이기 때문에 한 순간도 양보할 수 없다.
...
원리주의 개발자에게 시행착오의 기회를 주는 것이 바람직하다. 그러나 원리주의 개발자의 성장은 생각보다 더딜 것이다. 회사 입장에서는 투자이기 때문에 잘 따져봐야 한다.

이런 문제를 해결하려면 적어도 한 명의 유능한 상위 기술 책임자가 있어야 한다. 상위 기술 책임자는 원리주의 개발자의 시행착오를 크게 줄일 수 있다.
개발 방법론은 장식이 아니다. 개발 이론에 근거한 공학적 접근은 분명 필요하다. 문제는 개발 방법론을 깨닫는 것이 어렵기 때문에 많은 개발자가 시행착오를 겪게 되고 그렇게 실패하는 만큼 필요없는 것으로 생각되는 것이다.
