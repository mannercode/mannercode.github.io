...
[그림01: AI는 개발을 가속한다 - 8년 같았던 8개월. 주니어들은 허수아비. 대표는 마이웨이]

**대사**

이번 시간에는 지난 8개월간의 경험을 바탕으로, AI 코딩이 개발 환경을 어떻게 바꿔 놓았는지 이야기해 보겠습니다.
...
개발자가 코드를 직접 쓰고 고치면서 구현하는 전통적인 방식은 ‘직접 코딩’이라고 부르겠습니다.
요구사항을 설명해서 AI에게 코드 작성을 맡기고, 나온 결과를 검토하는 건 ‘AI 코딩’입니다.
...
상식적으로 생각하기엔 아무리 그래도 8년이나 출시를 못했을까 싶기는 합니다. 그러나 누군가의 가슴아픈 사연이기에 자세히 묻지는 못했습니다.

## 1.1 개발팀에 합류하다 - 남은 시간은 4주

**화면 내용**

**대사**

제가 합류했을 때는 미술관에 티켓 시스템을 납품하고 정식 운영을 시작하기까지 4주가 남아 있었습니다. 이미 납품 일정을 몇 번 미뤘기 때문에, 이번에도 맞추지 못하면 중요한 계약을 잃을 상황이었습니다.
...
자료: [사용자 앱의 Figma 시안 캡처](../attachments/figma-user-app-design.png).
...
![엉킨 서버 랙 배선과 정돈된 배선 비교](../attachments/server-rack-cabling.webp)
