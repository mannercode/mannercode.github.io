...
개발 환경을 정리하니 생산성이 높아지는 게 느껴졌다. 무엇을 해야 할지는 내가 잘 알고 있었기 때문에 에이전트 네 개에 동시에 작업을 맡기고 결과를 검증했다.
...
나는 이런 이유를 설명했다. 하지만 대표는 내 판단보다 AI의 제안을 더 신뢰했다. 내가 무슨 말을 해도 AI에게 다시 물어보고 답을 비교했다.

처음 대표를 만났을 때 의인불용 용인불의(疑人不用 用人不疑)를 이야기했지만, 대표는 달라진 게 없었다. 지금까지 많은 사람을 만나 봤지만 이런 경우는 처음이었고, 상상해 본 적도 없었다.

어쩌면 당연했다. 예전에는 개발자의 말을 그 자리에서 대조해 볼 AI가 없었으니까 말이다. 개발자에게 당했다고 생각하는 다른 비개발자 대표들도 비슷한 마음일지 모른다.
...
8개월 동안 레거시를 수습하고, AI 코딩으로 혼자 개발하고, 대표가 개발을 주도하는 프로젝트에서 일했다. 짧은 기간에 개발 방식과 내 역할이 여러 번 바뀌었다. AI 코딩은 구현뿐 아니라 이런 변화까지 가속했다.

AI가 코딩을 대신하면서 기능을 빠르게 구현하는 능력만으로는 개발자의 가치를 설명하기 어려워졌다. 그만큼 인간관계와 커뮤니케이션이 중요해졌다.

합류 당시의 개발팀장과 대표 사이에서도, 대표와 나 사이에서도 신뢰를 쌓는 데 실패했다. 서로의 판단을 조율하지 못하니 각자의 능력도 제대로 살리지 못했다.

그 불신의 시작에는 일부 개발자의 오만한 태도가 있었다. 과거에는 필요한 기술을 가진 개발자를 대체하기 어려웠고, 소통이 원활하지 않아도 상대방이 맞춰 주는 일이 많았다.

이제는 코드를 빠르게 작성한다는 이유만으로 협업하기 어려운 개발자를 고집할 이유가 없다. 구현은 AI에게 맡길 수 있기 때문이다. 개발자도 상대방의 입장을 이해하고 함께 일할 수 있는 관계를 만들어야 한다.

그렇다고 기술의 가치가 사라진 것은 아니다. 오히려 개발자에게 남은 문제의 난도는 더 높아졌다. 자료를 찾아보고 구현하는 일은 AI에게 상당 부분 맡길 수 있지만, 그 결과가 지금의 상황에 맞는지 판단하는 일은 여전히 남는다.

개발자에게 필요한 것은 세세한 부분까지 ‘왜’를 묻고 논리적으로 따져 보는 능력, 그리고 납득할 만한 근거를 찾을 때까지 파고드는 집요함이다. 왜 이런 구조여야 하는지, 이 데이터로 요구한 기능이 가능한지, 무엇을 근거로 정상이라고 하는지 묻고 실제 동작으로 확인해야 한다.

이런 집요함은 사업을 주도하는 대표의 성향과 충돌할 수 있다. 대표는 여러 아이디어를 빠르게 시도하며 가능성을 확인하려 하고, 엔지니어는 하나의 문제를 깊이 파고들어 제대로 해결하려 한다.

두 성향이 잘 협력하면 아이디어를 빠르게 시험하면서도 실제로 쓸 수 있는 서비스로 완성할 수 있다. 그러나 협력이 끊기면 기능만 빠르게 늘고, 문제는 해결되지 않은 채 쌓인다. AI가 구현의 속도를 높인 만큼, 서로 다른 성향의 사람들이 어떻게 협력할 것인지가 더 중요한 과제가 됐다.
