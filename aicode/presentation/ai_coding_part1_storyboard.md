# AI 코딩을 대하는 개발자의 자세 — 유튜브 구성안

원고: [AI 코딩을 대하는 개발자의 자세](../ai_coding_part1.md)

---

## 01. AI 코딩을 대하는 개발자의 자세
...
먼저 코딩 방식을 두 가지로 구분하겠다.

직접 코딩은 개발자가 코드를 직접 작성하고 수정하면서 구현하는 방식이다. AI 코딩은 개발자가 요구사항을 설명하고 AI에게 코드 작성과 수정을 맡긴 뒤 결과를 검토하는 방식이다.

이번 1편에서는 나를 포함한 참여자들이 어떤 입장에서 일했고, AI 코딩을 하면서 무엇을 겪었는지 돌아본다. 2편에서는 구체적인 기술 사례를 살펴보고 문제의 원인과 해결 방법을 모색하려고 한다.

---

## 03. 8년 동안 출시하지 못한 서비스
...
완공을 앞뒀다는 집에서 이런 문제가 발견되면, 단순히 마무리만 남았다고 말하기는 어렵다.

내가 합류했던 프로젝트도 이런 상태에 가까웠다.
...
전문가들의 논리적 근거를 듣고 최종 판단은 스스로 하겠다는 경영자는 적지 않다.

동아일보 딥다이브에서도 이런 문제를 다룬 적이 있다. 2024년 10월, 삼성전자에서 20년 정도 일한 익명 엔지니어를 인터뷰한 기사였다. 정현호 부회장에게 올리는 보고서를 초등학생도 알아들을 수 있게 써야 한다는 내부 비판이 나왔다.

경영 판단을 앞세워 현장의 기술적 우려를 밀어내고, 기술 경쟁력이 흔들리는 동안 엔지니어들마저 떠난다는 이야기는 흔히 들린다.

내가 이 기사를 떠올린 것도, 기술적 우려를 설명하는 사람과 최종 결정을 내리는 사람 사이의 간극 때문이었다.
...
드라마 《하얀거탑》에서 참관실의 교수가 수술에 개입하는 발췌 영상. ‘수술은 여기서 내가 통제하겠네!’라는 대사가 있는 장면, 원음 사용.

> “수술은 여기서 내가 통제하겠네!”

출처: [MBC 《하얀거탑》 공식 영상](https://www.youtube.com/watch?v=ke-jgZMIU6A&t=170s)

**대사**

개발의 주도권을 둘러싼 갈등을 이 장면에 빗대어 볼 수 있다. 드라마 하얀거탑의 한 장면이다.

다만 이 장면의 교수에게는 해당 분야의 경험과 인정받는 전문성이 있었다. 나는 프로젝트의 개발을 주도하면서도 개발 경험이 없는 대표가 AI와 정한 기술과 작업 방향을 따라가야 했다. 그 점에서 거부감이 컸다.

---

## 48. 4주가 필요했지만 2주를 요구했다
...
정리하지 않은 채 물건이 쌓이는 방의 이미지와 기능 간 연결이 얽히는 시스템 도식.
...
## 53. 구현 속도가 협업을 해결해 주지는 않았다

**화면 내용**

개발팀 합류, AI와 단독 개발, 대표 주도 개발로 이어진 8개월의 흐름.
